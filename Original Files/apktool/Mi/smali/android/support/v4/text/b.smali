.class Landroid/support/v4/text/b;
...
.method constructor <init>(Ljava/lang/String;Z)V
    ...
    iput-boolean p2, p0, Landroid/support/v4/text/b;->d:Z
...
.method a()I
    ...
    iget v7, p0, Landroid/support/v4/text/b;->e:I

    if-ge v6, v7, :cond_3

    if-nez v0, :cond_3

    invoke-virtual {p0}, Landroid/support/v4/text/b;->c()B
    ...
    invoke-virtual {p0}, Landroid/support/v4/text/b;->d()B
...
.method c()B
    ...
    iget-char v0, p0, Landroid/support/v4/text/b;->g:C
    ...
    invoke-static {v0}, Landroid/support/v4/text/b;->a(C)B

    move-result v0

    iget-boolean v1, p0, Landroid/support/v4/text/b;->d:Z
    ...
    invoke-direct {p0}, Landroid/support/v4/text/b;->e()B
    ...
    invoke-direct {p0}, Landroid/support/v4/text/b;->g()B
...
.method d()B
    ...
    invoke-direct {p0}, Landroid/support/v4/text/b;->f()B
    ...
    invoke-direct {p0}, Landroid/support/v4/text/b;->h()B
