...
.method public constructor <init>(Landroid/content/Context;Landroid/view/GestureDetector$OnGestureListener;Landroid/os/Handler;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/view/j;->a(Landroid/view/GestureDetector$OnDoubleTapListener;)V

    :cond_0
    invoke-direct {p0, p1}, Landroid/support/v4/view/j;->a(Landroid/content/Context;)V
...
.method static synthetic a(Landroid/support/v4/view/j;Z)Z
    ...
    iput-boolean p1, p0, Landroid/support/v4/view/j;->o:Z
...
.method static synthetic c(Landroid/support/v4/view/j;)V
    ...
    invoke-direct {p0}, Landroid/support/v4/view/j;->d()V
...
.method public a(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0}, Landroid/support/v4/view/j;->c()V
    ...
    iget-object v5, p0, Landroid/support/v4/view/j;->A:Landroid/view/VelocityTracker;
    ...
    iget-object v4, p0, Landroid/support/v4/view/j;->k:Landroid/os/Handler;
    ...
    iget-object v4, p0, Landroid/support/v4/view/j;->t:Landroid/view/MotionEvent;
    ...
    invoke-direct {p0, v0, v4, p1}, Landroid/support/v4/view/j;->a(Landroid/view/MotionEvent;Landroid/view/MotionEvent;Landroid/view/MotionEvent;)Z

    move-result v0

    if-eqz v0, :cond_c

    iput-boolean v8, p0, Landroid/support/v4/view/j;->u:Z
    ...
    iget-object v4, p0, Landroid/support/v4/view/j;->m:Landroid/view/GestureDetector$OnDoubleTapListener;
    ...
    iput-boolean v8, p0, Landroid/support/v4/view/j;->q:Z

    iput-boolean v8, p0, Landroid/support/v4/view/j;->r:Z

    iput-boolean v8, p0, Landroid/support/v4/view/j;->n:Z
    ...
    sget v4, Landroid/support/v4/view/j;->f:I

    int-to-long v4, v4

    add-long/2addr v2, v4

    sget v4, Landroid/support/v4/view/j;->e:I
    ...
    sget v4, Landroid/support/v4/view/j;->g:I
    ...
    iget v4, p0, Landroid/support/v4/view/j;->w:F

    sub-float/2addr v4, v1

    iget-boolean v5, p0, Landroid/support/v4/view/j;->u:Z
    ...
    :cond_e
    iget-boolean v5, p0, Landroid/support/v4/view/j;->q:Z

    if-eqz v5, :cond_10

    iget v5, p0, Landroid/support/v4/view/j;->x:F

    sub-float v5, v2, v5

    float-to-int v5, v5

    iget v6, p0, Landroid/support/v4/view/j;->y:F
    ...
    iget v6, p0, Landroid/support/v4/view/j;->a:I

    if-le v5, v6, :cond_1a

    iget-object v6, p0, Landroid/support/v4/view/j;->l:Landroid/view/GestureDetector$OnGestureListener;

    iget-object v7, p0, Landroid/support/v4/view/j;->s:Landroid/view/MotionEvent;
    ...
    iget v5, p0, Landroid/support/v4/view/j;->d:I
    ...
    iget v5, p0, Landroid/support/v4/view/j;->c:I
    ...
    :pswitch_6
    invoke-direct {p0}, Landroid/support/v4/view/j;->b()V
