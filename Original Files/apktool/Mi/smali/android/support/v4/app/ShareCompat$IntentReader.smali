...
.method private constructor <init>(Landroid/app/Activity;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->b:Landroid/app/Activity;

    invoke-virtual {p1}, Landroid/app/Activity;->getIntent()Landroid/content/Intent;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->c:Landroid/content/Intent;

    invoke-static {p1}, Landroid/support/v4/app/ShareCompat;->getCallingPackage(Landroid/app/Activity;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->d:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->e:Landroid/content/ComponentName;
...
.method public getCallingActivity()Landroid/content/ComponentName;
    ...
    iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->e:Landroid/content/ComponentName;
...
.method public getCallingActivityIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->e:Landroid/content/ComponentName;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->b:Landroid/app/Activity;
    ...
    :try_start_0
    iget-object v2, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->e:Landroid/content/ComponentName;
...
.method public getCallingApplicationIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->d:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->d:Ljava/lang/String;
...
.method public getCallingPackage()Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->d:Ljava/lang/String;
...
.method public getEmailBcc()[Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->c:Landroid/content/Intent;
...
.method public getHtmlText()Ljava/lang/String;
    ...
    invoke-static {}, Landroid/support/v4/app/ShareCompat;->a()Landroid/support/v4/app/Y;
...
.method public getStream(I)Landroid/net/Uri;
    ...
    iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->f:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->f:Ljava/util/ArrayList;
...
.method public isMultipleShare()Z
    ...
    iget-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentReader;->c:Landroid/content/Intent;
