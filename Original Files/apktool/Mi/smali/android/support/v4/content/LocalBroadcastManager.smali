...
.field private static j:Landroid/support/v4/content/LocalBroadcastManager;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/content/LocalBroadcastManager;->i:Ljava/lang/Object;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v4/content/l;-><init>(Landroid/support/v4/content/LocalBroadcastManager;Landroid/os/Looper;)V

    iput-object v0, p0, Landroid/support/v4/content/LocalBroadcastManager;->h:Landroid/os/Handler;
...
.method private a()V
    ...
    check-cast v0, Landroid/support/v4/content/n;
...
.method public static getInstance(Landroid/content/Context;)Landroid/support/v4/content/LocalBroadcastManager;
    ...
    sget-object v1, Landroid/support/v4/content/LocalBroadcastManager;->i:Ljava/lang/Object;
    ...
    sput-object v0, Landroid/support/v4/content/LocalBroadcastManager;->j:Landroid/support/v4/content/LocalBroadcastManager;
...
.method public registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    :try_start_0
    new-instance v3, Landroid/support/v4/content/n;
...
.method public sendBroadcast(Landroid/content/Intent;)Z
    ...
    :cond_2
    iget-boolean v1, v9, Landroid/support/v4/content/n;->c:Z
    ...
    :cond_4
    iget-object v1, v9, Landroid/support/v4/content/n;->a:Landroid/content/IntentFilter;
    ...
    check-cast v1, Landroid/support/v4/content/n;

    const/4 v3, 0x0

    iput-boolean v3, v1, Landroid/support/v4/content/n;->c:Z
    ...
    iget-object v1, v0, Landroid/support/v4/content/LocalBroadcastManager;->h:Landroid/os/Handler;
...
.method public unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    ...
    check-cast v3, Landroid/support/v4/content/n;

    iget-object v3, v3, Landroid/support/v4/content/n;->b:Landroid/content/BroadcastReceiver;
