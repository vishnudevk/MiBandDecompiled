...
.method public constructor <init>(Landroid/app/FragmentManager;)V
    ...
    iput-object v1, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->d:Landroid/app/FragmentTransaction;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->e:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->f:Ljava/util/ArrayList;

    iput-object v1, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->g:Landroid/app/Fragment;

    iput-object p1, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->c:Landroid/app/FragmentManager;
...
.method public destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->d:Landroid/app/FragmentTransaction;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->c:Landroid/app/FragmentManager;

    invoke-virtual {v0}, Landroid/app/FragmentManager;->beginTransaction()Landroid/app/FragmentTransaction;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->d:Landroid/app/FragmentTransaction;

    :cond_0
    :goto_0
    iget-object v0, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->e:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->c:Landroid/app/FragmentManager;
    ...
    iget-object v0, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->f:Ljava/util/ArrayList;
...
.method public restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    iget-object v4, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->e:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->c:Landroid/app/FragmentManager;
...
.method public saveState()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->e:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->e:Ljava/util/ArrayList;
...
.method public setPrimaryItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->g:Landroid/app/Fragment;
    ...
    :cond_1
    iput-object p3, p0, Landroid/support/v13/app/FragmentStatePagerAdapter;->g:Landroid/app/Fragment;
