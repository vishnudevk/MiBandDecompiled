    ...
    implements android.animation.Animator.AnimatorListener
{
    ...
    cd(StatisticFragment statisticfragment, StatisticChartView statisticchartview, StatisticChartView statisticchartview1)
    {
        c = statisticfragment;
    ...
    public void onAnimationStart(Animator animator)
    {
        ...
        a.setVisibility(0);
        if (StatisticFragment.l(c) != null)
        {
            StatisticFragment.l(c).needDraw = false;
        }
        b.refresh();
    }
}
