...
final class val.characteristic
    implements Runnable
{
...
_L1:
        ...
        Debug.DEBUG_LOCK((new StringBuilder()).append("NOTIFY: synchronizedReadCharacteristic(): ").append(AbsGattCallback.access$300()).toString());
...
_L2:
        boolean flag;
        flag = val$gatt.readCharacteristic(val$characteristic);
