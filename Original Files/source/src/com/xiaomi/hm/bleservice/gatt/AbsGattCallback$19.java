...
_L1:
        ...
        Debug.DEBUG_LOCK((new StringBuilder()).append("NOTIFY: synchronizedWriteDescriptor(): ").append(AbsGattCallback.access$300()).toString());
...
_L2:
        boolean flag;
        val$descriptor.setValue(val$value);
        flag = val$gatt.writeDescriptor(val$descriptor);
