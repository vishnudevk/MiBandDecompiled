...
_L3:
        boolean flag2;
        flag2 = obj instanceof GetResult;
        flag1 = false;
...
_L5:
        ...
        boolean flag8;
        boolean flag9;
        if (getresult.getTableName() == null)
        {
            flag3 = flag;
        } else
        {
...
_L6:
        ...
        flag9 = getresult.getTableName().equals(getTableName());
        flag1 = false;
        if (!flag9) goto _L4; else goto _L7
_L7:
        boolean flag6;
        if (getresult.getAttributes() == null)
        {
            flag6 = flag;
        } else
        {
...
_L8:
        ...
        flag8 = getresult.getAttributes().equals(getAttributes());
        flag1 = false;
...
_L9:
    ...
    public GetResult withAttributes(Map map)
    {
        setAttributes(map);
        return this;
    }

    public GetResult withTableName(String s)
    {
        setTableName(s);
        return this;
    }
