...
final class c
{
    ...
    public static final float a = 3F;
    private static final int b = 0x1fea8;
    private static final int c = 0x3fa29;
    ...
    private static final float e = 0.357F;
    private static final float f = 2F;
    private a g;
    private boolean h;
    private Compaction i;
    private int j;
    private int k;
    private int l;
    private int m;
    ...
    private static int a(int i1, int j1, int k1)
    {
        ...
        if (l1 > 90)
        {
            throw new WriterException("The message doesn't fit in the configured symbol size. The resultant number of rows for this barcode exceeds 90. Please increase the number of columns or decrease the error correction level to reduce the number of rows.");
        }
        if (l1 < 2)
        {
            throw new WriterException("The message is too short for the configured symbol size. The resultant number of rows is less than 3. Please decrease the number of columns or increase the error correction level to increase the number of rows.");
        } else
        {
            return l1;
        }
    ...
    private static void a(int i1, int j1, b b1)
    {
        int k1 = 1 << j1 - 1;
        boolean flag;
        int l1;
    ...
    private void a(CharSequence charsequence, int i1, int j1, int k1, a a1)
    {
        int l1 = 0;
        int i2 = 0;
        while (i2 < j1) 
        {
            ...
            if (j2 == 1)
            {
                k2 = 30 * (i2 / 3) + k1 * 3 + (j1 - 1) % 3;
                l2 = 30 * (i2 / 3) + (j1 - 1) / 3;
            } else
            {
                k2 = 30 * (i2 / 3) + (i1 - 1);
                l2 = 30 * (i2 / 3) + k1 * 3 + (j1 - 1) % 3;
            }
            a(d[j2][k2], 17, a1.b());
            for (int i3 = 0; i3 < i1; i3++)
            {
                a(d[j2][charsequence.charAt(l1)], 17, a1.b());
                l1++;
            }
    ...
    private static int c(int i1, int j1, int k1)
    {
        int l1 = com.google.zxing.pdf417.encoder.d.a(j1);
        return k1 * a(i1, l1, k1) - l1;
    }
    ...
    {
        int j1 = 0;
        int k1 = com.google.zxing.pdf417.encoder.d.a(i1);
        String s1 = com.google.zxing.pdf417.encoder.e.a(s, i);
        int l1 = s1.length();
        int ai[] = a(l1, k1);
        int i2 = ai[0];
        int j2 = ai[1];
        int k2 = b(l1, k1, i2, j2);
        if (1 + (k1 + l1) > 929)
        {
            throw new WriterException((new StringBuilder()).append("Encoded message contains to many code words, message to big (").append(s.length()).append(" bytes)").toString());
        }
        int l2 = 1 + (l1 + k2);
        ...
        String s3 = com.google.zxing.pdf417.encoder.d.a(s2, i1);
        String s4 = (new StringBuilder()).append(s2).append(s3).toString();
        g = new a(j2, i2);
        a(((CharSequence) (s4)), i2, j2, i1, g);
    }
...
_L1:
        f2 = (0.357F * (float)(69 + k1 * 17)) / (2.0F * (float)l1);
        if (ai == null || Math.abs(f2 - 3F) <= Math.abs(f1 - 3F))
        {
            ai = (new int[] {
                k1, l1
            });
