...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/PagerTabStrip;->t:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroid/support/v4/view/PagerTabStrip;->u:Landroid/graphics/Rect;

    const/16 v0, 0xff

    iput v0, p0, Landroid/support/v4/view/PagerTabStrip;->v:I

    iput-boolean v4, p0, Landroid/support/v4/view/PagerTabStrip;->w:Z
    ...
    iget v1, p0, Landroid/support/v4/view/PagerTabStrip;->n:I
    ...
    iput v0, p0, Landroid/support/v4/view/PagerTabStrip;->r:I
    ...
    iput v0, p0, Landroid/support/v4/view/PagerTabStrip;->C:I
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/view/N;-><init>(Landroid/support/v4/view/PagerTabStrip;)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/view/O;-><init>(Landroid/support/v4/view/PagerTabStrip;)V
    ...
    iput-boolean v5, p0, Landroid/support/v4/view/PagerTabStrip;->w:Z
...
.method a(IFZ)V
    ...
    iget v3, p0, Landroid/support/v4/view/PagerTabStrip;->s:I
    ...
    iget v4, p0, Landroid/support/v4/view/PagerTabStrip;->s:I
    ...
    iput v2, p0, Landroid/support/v4/view/PagerTabStrip;->v:I
    ...
    iget v5, p0, Landroid/support/v4/view/PagerTabStrip;->s:I
...
.method public getDrawFullUnderline()Z
    ...
    iget-boolean v0, p0, Landroid/support/v4/view/PagerTabStrip;->w:Z
...
.method public getTabIndicatorColor()I
    ...
    iget v0, p0, Landroid/support/v4/view/PagerTabStrip;->n:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v2, p0, Landroid/support/v4/view/PagerTabStrip;->s:I
    ...
    iget-object v1, p0, Landroid/support/v4/view/PagerTabStrip;->t:Landroid/graphics/Paint;
    ...
    iget-object v5, p0, Landroid/support/v4/view/PagerTabStrip;->t:Landroid/graphics/Paint;
    ...
    iget v0, p0, Landroid/support/v4/view/PagerTabStrip;->y:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v3, p0, Landroid/support/v4/view/PagerTabStrip;->z:Z
    ...
    iput-boolean v0, p0, Landroid/support/v4/view/PagerTabStrip;->z:Z
    ...
    iget v2, p0, Landroid/support/v4/view/PagerTabStrip;->C:I
    ...
    :cond_2
    iput-boolean v1, p0, Landroid/support/v4/view/PagerTabStrip;->z:Z
...
.method public setBackgroundColor(I)V
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/v4/view/PagerTabStrip;->w:Z
...
.method public setDrawFullUnderline(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v4/view/PagerTabStrip;->w:Z
...
.method public setPadding(IIII)V
    ...
    iget p4, p0, Landroid/support/v4/view/PagerTabStrip;->p:I
...
.method public setTextSpacing(I)V
    ...
    iget p1, p0, Landroid/support/v4/view/PagerTabStrip;->q:I
