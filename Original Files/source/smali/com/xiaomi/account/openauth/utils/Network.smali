...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/xiaomi/account/openauth/utils/a;

    invoke-direct {v0}, Lcom/xiaomi/account/openauth/utils/a;-><init>()V

    sput-object v0, Lcom/xiaomi/account/openauth/utils/Network;->c:Ljavax/net/ssl/HostnameVerifier;

    new-instance v0, Lcom/xiaomi/account/openauth/utils/b;

    invoke-direct {v0}, Lcom/xiaomi/account/openauth/utils/b;-><init>()V

    sput-object v0, Lcom/xiaomi/account/openauth/utils/Network;->d:Ljavax/net/ssl/TrustManager;
...
.method public static beginDownloadFile(Ljava/lang/String;Ljava/io/OutputStream;Landroid/content/Context;ZLcom/xiaomi/account/openauth/utils/Network$PostDownloadHandler;)V
    ...
    new-instance v0, Lcom/xiaomi/account/openauth/utils/c;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/xiaomi/account/openauth/utils/c;-><init>(Ljava/lang/String;Ljava/io/OutputStream;Lcom/xiaomi/account/openauth/utils/Network$PostDownloadHandler;ZLandroid/content/Context;)V

    const/4 v1, 0x0

    new-array v1, v1, [Ljava/lang/Void;

    invoke-virtual {v0, v1}, Lcom/xiaomi/account/openauth/utils/c;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public static beginDownloadFile(Ljava/lang/String;Ljava/io/OutputStream;Lcom/xiaomi/account/openauth/utils/Network$PostDownloadHandler;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/xiaomi/account/openauth/utils/c;-><init>(Ljava/lang/String;Ljava/io/OutputStream;Lcom/xiaomi/account/openauth/utils/Network$PostDownloadHandler;)V
...
.method public static doHttpPost(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;Ljava/util/Map;Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lcom/xiaomi/account/openauth/utils/Network;->c:Ljavax/net/ssl/HostnameVerifier;
    ...
    invoke-static {p0, v0}, Lcom/xiaomi/account/openauth/utils/Network;->getHttpUrlConnection(Landroid/content/Context;Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    sget-object v0, Lcom/xiaomi/account/openauth/utils/Network;->d:Ljavax/net/ssl/TrustManager;
    ...
    :cond_3
    invoke-static {p2}, Lcom/xiaomi/account/openauth/utils/Network;->fromParamListToString(Ljava/util/List;)Ljava/lang/String;
    ...
    iput v0, p4, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->ResponseCode:I

    iget-object v0, p4, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->AllHeaders:Ljava/util/Map;
    ...
    iput-object v0, p4, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->AllHeaders:Ljava/util/Map;
    ...
    invoke-direct {v3, v1}, Lcom/xiaomi/account/openauth/utils/Network$DoneHandlerInputStream;-><init>(Ljava/io/InputStream;)V
    ...
    :cond_8
    iget-object v4, p4, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->AllHeaders:Ljava/util/Map;
...
.method public static doHttpPostWithResponseStatus(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-static {v0}, Lcom/xiaomi/account/openauth/utils/Network;->getCMWapUrl(Ljava/net/URL;)Ljava/lang/String;
...
.method public static downloadFile(Ljava/lang/String;Ljava/io/OutputStream;Landroid/content/Context;)Z
    ...
    invoke-static {p2}, Lcom/xiaomi/account/openauth/utils/Network;->isCmwap(Landroid/content/Context;)Z
...
.method public static downloadXmlAsStream(Landroid/content/Context;Ljava/net/URL;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;)Ljava/io/InputStream;
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/account/openauth/utils/Network;->getHttpUrlConnection(Landroid/content/Context;Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    iput v0, p5, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->ResponseCode:I

    iget-object v0, p5, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->AllHeaders:Ljava/util/Map;
    ...
    iput-object v0, p5, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->AllHeaders:Ljava/util/Map;
    ...
    :goto_3
    new-instance v1, Lcom/xiaomi/account/openauth/utils/Network$DoneHandlerInputStream;

    invoke-direct {v1, v0}, Lcom/xiaomi/account/openauth/utils/Network$DoneHandlerInputStream;-><init>(Ljava/io/InputStream;)V
    ...
    :cond_b
    iget-object v4, p5, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->AllHeaders:Ljava/util/Map;
...
.method public static getHttpHeaderInfo(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;
    ...
    :cond_2
    new-instance v2, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;

    invoke-direct {v2}, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;-><init>()V

    invoke-virtual {v0}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v4

    iput v4, v2, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->ResponseCode:I

    iput-object p1, v2, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->UserAgent:Ljava/lang/String;
    ...
    iput-object v5, v2, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->ContentType:Ljava/lang/String;
    ...
    iput-object v3, v2, Lcom/xiaomi/account/openauth/utils/Network$HttpHeaderInfo;->realUrl:Ljava/lang/String;
    :try_end_1
...
.method public static tryDetectCharsetEncoding(Ljava/net/URL;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lcom/xiaomi/account/openauth/utils/Network;->ContentTypePattern_Charset:Ljava/util/regex/Pattern;
    ...
    sget-object v4, Lcom/xiaomi/account/openauth/utils/Network;->ContentTypePattern_MimeType:Ljava/util/regex/Pattern;
    ...
    invoke-direct {v3, v0}, Lcom/xiaomi/account/openauth/utils/Network$DoneHandlerInputStream;-><init>(Ljava/io/InputStream;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sget-object v0, Lcom/xiaomi/account/openauth/utils/Network;->ContentTypePattern_XmlEncoding:Ljava/util/regex/Pattern;
...
.method public static uploadFile(Ljava/lang/String;Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v7, Lcom/xiaomi/account/openauth/utils/Network$DoneHandlerInputStream;

    invoke-virtual {v0}, Ljava/net/HttpURLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object v0

    invoke-direct {v7, v0}, Lcom/xiaomi/account/openauth/utils/Network$DoneHandlerInputStream;-><init>(Ljava/io/InputStream;)V
